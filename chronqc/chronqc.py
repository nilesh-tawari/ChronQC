...
def main():
    try:
        ...
        group.add_argument('-c', '--create', action='store_const', dest='mode',
                           ...
                           provided by {-db} argument.")
        db_requiredNamed.add_argument('-db_table', '--db_table', required=False,
                               help='Name of ChronQC SQLlite database table \
                               to be created/updated. Default name is \
                               chronqc_stats_data. ')
        db_requiredNamed.add_argument('-panel', '--panel', required=True,
        ...
        plot_requiredNamed.add_argument('-db', '--db', required=True,
                                 help='Input SQLite database name.')

        plot_requiredNamed.add_argument('-json', '--json', required=True,
                                 help='Input JSON filename with plot \
                                 properties.')
        plot_requiredNamed.add_argument('-panel', '--panel', required=True,
